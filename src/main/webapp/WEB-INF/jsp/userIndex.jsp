...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<div class="navbar-logo">
					<a href="index.html"><img data-0="width:155px;"
						data-300=" width:120px;" src="img/logo.png" alt=""></a>
				</div>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav" data-0="margin-top:20px;"
					data-300="margin-top:5px;">
					<li class="active"><a href="#">借书主页</a></li>

					<li><a href="#section-works">查看公告</a></li>
					<li><a href="#section-contact">个人主页</a></li>
					<li><a href="#">注销</a></li>
				</ul>
			</div>
			<!--/.navbar-collapse -->
	...
	<div class="intro-content">
		...
		<div>
			<a href="#section-about" class="btn-get-started scrollto">搜索图书</a>
		</div>
	</div>
	</section>
